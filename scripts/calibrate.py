#!/usr/bin/env python3
"""Self-calibration: blend public priors with our own round data -> priors.json.

Usage: python scripts/calibrate.py [state.json] [priors.json]
"""
import json
import sys
...
from hehua.orchestrate.scheduler import PRIOR, prefix_of  # noqa: E402

MIN_ATTEMPTS = 3  # trust own rate only with enough samples
