...
glm_starts = [e.get('code') for e in events if e.get('type') == 'challenge_start' and e.get('phase') == 'GLM']
glm_solved = [e.get('code') for e in events if e.get('type') == 'challenge_end' and e.get('status') == 'solved' and (e.get('code') in set(glm_starts))]
